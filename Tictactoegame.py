#i honestly dont know why i imported sys but just on case something crazy happens
import pygame,sys
        ...
        if event.type == pygame.MOUSEBUTTONUP:
            ...
            if top_left.collidepoint(pos) and top_left_taken:
                ...
                if turns == 'X':
                    ...
                    #draws on command of the input of the mouse
                    pygame.draw.rect(screen, red , [25, 25, 50, 41.67])
                ...
                if turns == 'X':
                    pygame.draw.rect(screen ,red ,[125, 25, 50, 41.67])
                    board[1] = 1
                    pygame.mouse.set_cursor(*pygame.cursors.diamond)
                    turns = 'O'
                else:
                ...
                if turns == 'X':
                    pygame.draw.rect(screen, red , [225 ,25 ,50,41.67])
                    board[2] = 1
                    pygame.mouse.set_cursor(*pygame.cursors.diamond)                    
                    turns = 'O'
                else:
                ...
                if turns == 'X' and center_left_taken:
                    pygame.draw.rect(screen, red, [25, 110 , 50, 41.67] )
                    board[3] = 1
                    pygame.mouse.set_cursor(*pygame.cursors.diamond)
                    turns = 'O'
                else:
                ...
                if turns == 'X':
                    pygame.draw.rect(screen, red ,[130, 110 , 50, 41.67])
                    board[4] = 1
                    pygame.mouse.set_cursor(*pygame.cursors.diamond)
                    turns = 'O'
                else:
                ...
                if turns == 'X':
                    pygame.draw.rect(screen, red, [225, 110, 50 ,41.67])
                    board[5] = 1
                    pygame.mouse.set_cursor(*pygame.cursors.diamond)
                    turns = 'O'
                else:
                ...
                if turns == 'X':
                    pygame.draw.rect(screen , red, [25, 190, 50 ,41.67])
                    board[6] = 1
                    pygame.mouse.set_cursor(*pygame.cursors.diamond)
                    turns = 'O'
                else:
                ...
                if turns == 'X':
                    pygame.draw.rect(screen, red,[125, 190, 50,41.67])
                    board[7] = 1
                    pygame.mouse.set_cursor(*pygame.cursors.diamond)
                    turns = 'O'
                else:
                ...
                if turns == 'X':
                    pygame.draw.rect(screen, red, [220, 190, 50, 41.67])
                    board[8] = 1
                    pygame.mouse.set_cursor(*pygame.cursors.diamond)
                    turns = 'O'
                else:
